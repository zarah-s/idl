...
const Footer = () => {
  return (
    <footer className="p-5 bg-[#047C01] sm:p-6 text-white">
      <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
          <span className="self-center text-3xl font-bold whitespace-nowrap ">
            IDL
          </span>
          <p className="">IDL is a blah blah blah blah</p>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-2 lg:gap-11 gap-8 sm:gap-6 sm:grid-cols-2">
          <div>
            ...
            <ul className="">
              <li>
                <a href="mailto:devvick@gmail.com" className="hover:underline ">
                  IDL@gmail.com
                </a>
              </li>
              <ContactItem text="02212133321" />
              <ContactItem text="02212133321" />
              <ContactItem text="02212133321" />
              <ContactItem text="02212133321" />
            </ul>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a href="#" className="text-[#ffffff80]  ">
            <svg
              className="w-5 h-5"
              fill="currentColor"
              viewBox="0 0 24 24"
